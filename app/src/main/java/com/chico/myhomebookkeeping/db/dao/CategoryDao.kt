...
interface CategoryDao {
    ...
    @Query("SELECT * FROM category_table WHERE category_name IN (:names) OR category_name_ru IN (:names) OR category_name_pl IN (:names) OR category_name_de IN (:names) OR category_name_be IN (:names) OR category_name_be_latn IN (:names) ORDER BY categoriesId ASC LIMIT 1")
