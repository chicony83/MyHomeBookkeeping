...
class FullMoneyMoving (
    ...
    @ColumnInfo(name = "category_icon_key_value")
    val categoryIconKeyValue: String?,
    ...
    @ColumnInfo(name = "parent_category_icon_key_value")
    val parentCategoryIconKeyValue: String?,
