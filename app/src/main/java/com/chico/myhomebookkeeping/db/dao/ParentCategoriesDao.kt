...
interface ParentCategoriesDao {
    ...
    @Query("SELECT * FROM parent_categories_table WHERE parent_category_name = :name OR parent_category_name_ru = :name OR parent_category_name_pl = :name ORDER BY id ASC LIMIT 1")
