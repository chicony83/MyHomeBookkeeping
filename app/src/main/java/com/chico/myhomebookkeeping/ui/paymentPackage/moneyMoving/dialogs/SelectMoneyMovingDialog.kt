package com.chico.myhomebookkeeping.ui.paymentPackage.moneyMoving.dialogs
...
class SelectMoneyMovingDialog(
    ...
    private fun bindLayout(layout: View) {
        ...
        if (fullMoneyMoving != null) {
            ...
            category.text = fullMoneyMoving.categoryDisplayName ?: fullMoneyMoving.paymentTypeName
