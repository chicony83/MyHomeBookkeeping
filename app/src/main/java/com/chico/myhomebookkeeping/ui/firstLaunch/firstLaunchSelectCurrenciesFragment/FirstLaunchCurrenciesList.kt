...
object FirstLaunchCurrenciesList {
    private val majorCurrenciesList = listOf(
        Currencies("Belarusian ruble", "Br.", "BYN", null, false),
        ...
        Currencies("Polish złoty", "zł", "PLN", null, false),
        Currencies("Ukrainian hryvnia", "₴", "UAH", null, false),
    ...
    private val otherFiatCurrenciesList = listOf(
        ...
        Currencies("Azerbaijani manat", "man.", "AZN", null, false),
        ...
        Currencies("Georgian lari", "ლ", "GEL", null, false),
        Currencies("Hong Kong dollar", "HK\$", "HKD", null, false),
        Currencies("Hungarian forint", "Ft", "HUF", null, false),
        Currencies("Armenian dram", "֏", "AMD", null, false),
        Currencies("Indian rupee", "₹", "INR", null, false),
        Currencies("Israeli new shekel", "₪", "ILS", null, false),
        Currencies("Kyrgyzstani som", "с", "KGS", null, false),
        Currencies("South Korean won", "₩", "KRW", null, false),
        Currencies("Kazakhstani tenge", "₸", "KZT", null, false),
        Currencies("Moldovan leu", "L", "MDL", null, false),
        ...
        Currencies("Tajikistani somoni", "смн.", "TJS", null, false),
        Currencies("Turkish lira", "₺", "TRY", null, false),
        Currencies("Turkmenistani manat", "m", "TMT", null, false),
        Currencies("Uzbekistani som", "So'm", "UZS", null, false),
        Currencies("South African rand", "R", "ZAR", null, false),
        Currencies("Afghan afghani", "؋", "AFN", null, false),
        Currencies("Albanian lek", "L", "ALL", null, false),
        ...
        Currencies("Nigerian naira", "₦", "NGN", null, false),
