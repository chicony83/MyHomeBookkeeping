...
object FirstLaunchCurrenciesList {
    private val majorCurrenciesList = listOf(
        ...
        Currencies("Polski złoty", "zł", "PLN", null, false),
        Currencies("Украинская гривна", "₴", "UAH", null, false),
    ...
    private val otherFiatCurrenciesList = listOf(
        ...
        Currencies("Болгарский лев", "лв", "BGN", null, false),
        ...
        Currencies("Magyar forint", "Ft", "HUF", null, false),
        ...
        Currencies("Киргизский сом", "с", "KGS", null, false),
        Currencies("South Korean won", "₩", "KRW", null, false),
        Currencies("Казахстанский тенге", "₸", "KZT", null, false),
        ...
        Currencies("Таджикский сомони", "смн.", "TJS", null, false),
        ...
        Currencies("Сербский динар", "дин.", "RSD", null, false),
